...
func Migrate(db *gorm.DB) {
	err := db.AutoMigrate(voucher.VoucherModels{}, users.UserModels{}, users.AddressModels{}, products.CategoryModels{}, products.ProductModels{}, products.ProductPhotosModels{}, review.ReviewModels{})
	if err != nil {
		return
	}
}
