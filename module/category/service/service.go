...
func (s *CategoryService) CreateCategory(categoryData *domain.CategoryModels) (*domain.CategoryModels, error) {
...
func (s *CategoryService) GetAllCategory(page, perPage int) ([]*domain.CategoryModels, int64, error) {
...
func (s *CategoryService) GetCategoryByName(page int, perPage int, name string) ([]*domain.CategoryModels, int64, error) {
...
func (s *CategoryService) UpdateCategoryById(id int, updatedCategory *domain.CategoryModels) (*domain.CategoryModels, error) {
