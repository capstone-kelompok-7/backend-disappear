...
func (s *ChallengeService) GetAllChallenges(page, perPage int) ([]domain.ChallengeModels, int64, error) {
...
func (s *ChallengeService) GetChallengeByTitle(page, perPage int, title string) ([]domain.ChallengeModels, int64, error) {
