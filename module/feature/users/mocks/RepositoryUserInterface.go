...
// CreateUserPersonalization provides a mock function with given fields: userID, req
func (_m *RepositoryUserInterface) CreateUserPersonalization(userID uint64, req *dto.UserPersonalizationRequest) ([]*entities.PersonalizationModels, error) {
	ret := _m.Called(userID, req)

	var r0 []*entities.PersonalizationModels
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64, *dto.UserPersonalizationRequest) ([]*entities.PersonalizationModels, error)); ok {
		return rf(userID, req)
	}
	if rf, ok := ret.Get(0).(func(uint64, *dto.UserPersonalizationRequest) []*entities.PersonalizationModels); ok {
		r0 = rf(userID, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*entities.PersonalizationModels)
		}
	}

	if rf, ok := ret.Get(1).(func(uint64, *dto.UserPersonalizationRequest) error); ok {
		r1 = rf(userID, req)
	} else {
		r1 = ret.Error(1)
	}
...
// FindAllEnvironmentsIsues provides a mock function with given fields:
func (_m *RepositoryUserInterface) FindAllEnvironmentsIsues() ([]*entities.EnvironmentIssuesModels, error) {
	ret := _m.Called()
...
// FindAllPersonalization provides a mock function with given fields:
func (_m *RepositoryUserInterface) FindAllPersonalization() ([]*entities.PersonalizationModels, error) {
	ret := _m.Called()

	var r0 []*entities.PersonalizationModels
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]*entities.PersonalizationModels, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []*entities.PersonalizationModels); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*entities.PersonalizationModels)
...
// GetUserPersonalization provides a mock function with given fields: userID
func (_m *RepositoryUserInterface) GetUserPersonalization(userID uint64) ([]*entities.PersonalizationModels, error) {
	ret := _m.Called(userID)

	var r0 []*entities.PersonalizationModels
	var r1 error
	if rf, ok := ret.Get(0).(func(uint64) ([]*entities.PersonalizationModels, error)); ok {
		return rf(userID)
	}
	if rf, ok := ret.Get(0).(func(uint64) []*entities.PersonalizationModels); ok {
		r0 = rf(userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*entities.PersonalizationModels)
