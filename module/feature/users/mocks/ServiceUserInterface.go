...
func (_m *ServiceUserInterface) CreateUserPersonalization(userID uint64, req *dto.UserPersonalizationRequest) ([]*entities.PersonalizationModels, error) {
...
func (_m *ServiceUserInterface) GetAllEnvironmentsIsues() ([]*entities.EnvironmentIssuesModels, error) {
	ret := _m.Called()
...
func (_m *ServiceUserInterface) GetAllUserPersonalization() ([]*entities.PersonalizationModels, error) {
	ret := _m.Called()
...
func (_m *ServiceUserInterface) GetUserPersonalization(userID uint64) ([]*entities.PersonalizationModels, error) {
	ret := _m.Called(userID)
