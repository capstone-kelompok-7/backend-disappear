...
func TestRegister(t *testing.T) {
	...
	t.Run("Kasus Hash Password Gagal", func(t *testing.T) {
		...
		repo.AssertNotCalled(t, "Register", mock.AnythingOfType("*dto.UserModels"))
	})
	...
	t.Run("Kasus Sukses", func(t *testing.T) {
		...
		repo.On("Register", mock.AnythingOfType("*dto.UserModels")).Return(&entities.UserModels{
			Email:    newUser.Email,
	...
	t.Run("Kasus Gagal", func(t *testing.T) {
		...
		repo.On("Register", mock.AnythingOfType("*dto.UserModels")).Return(nil, expectedErr).Once()
